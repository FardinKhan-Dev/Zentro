            ...
            >
                ...
                <div className="text-center mb-12">
                    <motion.div
                        ...
                        className="w-24 h-24 bg-green-700 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg"
                    >
                ...
                <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-none overflow-hidden border border-gray-100 dark:border-zinc-800">
                    ...
                    <div className="bg-gray-50/50 dark:bg-zinc-800/50 border-b border-gray-100 dark:border-zinc-800 p-8">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute top-1/2 left-4 w-[10%] h-1 bg-green-700 -translate-y-1/2 rounded-full" />
                            <div className="relative flex justify-between">
                                <div className="flex flex-col items-center gap-2">
                                    <div className="w-8 h-8 bg-green-700 text-white rounded-full flex items-center justify-center ring-4 ring-white z-10 shadow-sm">
                                        <FiCheck size={16} />
                                    </div>
