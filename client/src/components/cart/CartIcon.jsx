...
const CartIcon = () => {
    ...
    return (
        ...
        >
            ...
            {itemCount > 0 && (
                <span
                    className="absolute top-0 right-0 flex items-center justify-center min-w-[18px] h-[18px] text-[10px] font-semibold text-white bg-green-700 rounded-full px-1 shadow-sm animate-bounce-in"
