...
import { useUpdateCartItemMutation, useRemoveFromCartMutation } from './cartApi';
...
const CartItem = ({ item }) => {
    ...
    return (
        <div className={`flex gap-4 p-4 bg-white border border-gray-200 rounded-lg transition-opacity ${isProcessing ? 'opacity-60 pointer-events-none' : ''}`}>
